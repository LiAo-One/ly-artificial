 ...
 */
@RestController
@RequestMapping("/sys-cardcancel")
@Api(tags = {"解绑卡机表"})
public class SysCardcancelController {

    @Autowired
    private SysCardcancelService sysCardcancelService;
    ...
    public R selPage(SysCardcancel recode) {
        return sysCardcancelService.selPage(recode);
    }
    ...
    public R findById(Long id){
        return sysCardcancelService.findById(id);
    }
    ...
    public R findByIds(@RequestParam("ids") List<Long> ids){
        return sysCardcancelService.findByIds(ids);
    }
    ...
    public R add(SysCardcancel recode) {
        return sysCardcancelService.add(recode);
    }
    ...
    public R upd(SysCardcancel recode) {
        return sysCardcancelService.updById(recode);
    }
    ...
    public R delete(Long id){
        return sysCardcancelService.delete(id);
    }
    ...
    public R deletes(@RequestParam("ids") List<Long> ids){
        return sysCardcancelService.deletes(ids);
    }
}
