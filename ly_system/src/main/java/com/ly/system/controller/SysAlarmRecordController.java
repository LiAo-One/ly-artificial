 ...
 */
@RestController
@RequestMapping("/sys-alarm-record")
@Api(tags = {"报警记录"})
public class SysAlarmRecordController {

    @Autowired
    private SysAlarmRecordService sysAlarmRecordService;
    ...
    public R selPage(SysAlarmRecord recode) {
        return sysAlarmRecordService.selPage(recode);
    }
    ...
    public R findById(Long id){
        return sysAlarmRecordService.findById(id);
    }
    ...
    public R findByIds(@RequestParam("ids") List<Long> ids){
        return sysAlarmRecordService.findByIds(ids);
    }
    ...
    public R add(SysAlarmRecord recode) {
        return sysAlarmRecordService.add(recode);
    }
    ...
    public R upd(SysAlarmRecord recode) {
        return sysAlarmRecordService.updById(recode);
    }
    ...
    public R delete(Long id){
        return sysAlarmRecordService.delete(id);
    }
    ...
    public R deletes(@RequestParam("ids") List<Long> ids){
        return sysAlarmRecordService.deletes(ids);
    }
}
