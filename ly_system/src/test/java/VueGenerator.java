...
import com.ly.generator.config.GenConfig;
import com.ly.generator.entity.GenTableColumn;
...
public class VueGenerator {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://120.55.96.180:3306/ly-artificial?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
            String user = "root";
            String pass = "root";
    ...
    public static List<GenConfig> getGenConfig(String[] tables) {
        ...
        for (String table : tables) {
            ...
            getTableData(genConfig, "ly-artificial", table);
            getGenConfig(genConfig.getColumns(), "ly-artificial", table);
